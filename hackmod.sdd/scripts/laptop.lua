...
local function RestoreAfterDelay(unitID)
	...
	Sleep(RESTORE_DELAY)
	Turn(base, y_axis, 0, math.rad(35))
...
function script.AimWeapon(weaponID, heading, pitch)
	...
	Turn(base, y_axis, heading, math.rad(35))
	Turn(base, x_axis, -pitch, math.rad(30))
...
function script.QueryWeapon() return body end
