...
local mapinfo = {
	name        = "Motherboard",
	shortname   = "MB",
	description = "Motherboard map for Hack Mod",
	author      = "Billy Schweigert",
	version     = "v1",
	--mutator   = "deployment";
	...
	teams = {
		[0] = {startPos = {x = 566, z = 522}},
		[1] = {startPos = {x = 3394, z = 1204}},
		[2] = {startPos = {x = 3333, z = 3487}},
		[3] = {startPos = {x = 935, z = 3289}},
	},
